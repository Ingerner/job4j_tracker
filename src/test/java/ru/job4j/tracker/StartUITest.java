...
public class StartUITest {
    ...
    public void whenReplaceItem() {
        ...
        List<UserAction> actions = Arrays.asList(new ReplaceItem(output), new Exit(output));
        new StartUI(output).init(in, tracker, actions);
    ...
    public void whenDeleteItem() {
        ...
        List<UserAction> actions = Arrays.asList(new DeteleAction(output), new Exit(output));
        new StartUI(output).init(in, tracker, actions);
    ...
    public void whenExit() {
        ...
        MemTracker tracker = new MemTracker();
        List<UserAction> actions = Arrays.asList(new Exit(out));
    ...
    public void whenReplaceItemTestOutputIsSuccessfully() {
        ...
        List<UserAction> actions = Arrays.asList(new ReplaceItem(out), new Exit(out));
        new StartUI(out).init(in, tracker, actions);
    ...
    public void whenFindAllActionItemTestOutputIsSuccessfully() {
        ...
        List<UserAction> actions = Arrays.asList(new DisplayAllAction(out), new Exit(out));
        new StartUI(out).init(in, tracker, actions);
        String ln = System.lineSeparator();
        assertThat(out.toString(), is(
                "Menu:" + ln
    ...
    public void whenReceivingActionNameTestOutputIsSuccessfully() {
        ...
        List<UserAction> actions = Arrays.asList(new ReceivingActionName(out), new Exit(out));
        new StartUI(out).init(in, tracker, actions);
        String ln = System.lineSeparator();
        assertThat(out.toString(), is(
                "Menu:" + ln
    ...
    public void whenReceivingActionIdTestOutputIsSuccessfully() {
        ...
        List<UserAction> actions = Arrays.asList(new ReceivingActionId(out), new Exit(out));
        new StartUI(out).init(in, tracker, actions);
        String ln = System.lineSeparator();
        assertThat(out.toString(), is(
                "Menu:" + ln
